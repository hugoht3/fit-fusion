...
function goalMessage(result) {
    ...
    let message = `${result} Calories are approximately equal to:
    ${hoursOfRunning.toFixed(2)} hours of Running
    ${hoursOfBasketball.toFixed(2)} hours of Basketball
    ${hoursOfVolleyball.toFixed(2)} hours of Volleyball
    ${hoursOfFootball.toFixed(2)} hours of Football
    ${hoursOfCycling.toFixed(2)} hours of Cycling`;
...
function loseWeight() {
    ...
    const result = sex === "male" ? calculateBmrMale() : calculateBmrFemale();
    let message = `Tips for Losing Weight
    Calorie Deficit: Consume fewer calories than your body burns (${result} calories).
...
function gainWeight() {
    ...
    Increase Caloric Intake: Consume more calories than your body burns (${result} calories).
